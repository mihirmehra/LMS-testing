...
// Define the types here (without 'export' keyword at this line)
type ToastProps = React.ComponentPropsWithoutRef<typeof Toast>;
type ToastActionElement = React.ReactElement<typeof ToastAction>;

// Export all components and types in a single block
export {
  Toast,
  ToastProvider,
  ToastViewport,
  ...
  ToastTitle,
  ToastDescription,
  type ToastProps, // Exporting ToastProps type
  type ToastActionElement, // Exporting ToastActionElement type
};